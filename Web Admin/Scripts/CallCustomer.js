...
function showdata(callback) {
    $.ajax({
        ...
        url: baseUrl + '/Customer/GetCall?Param=GetCall',
        type: 'GET',
        success: function (data) {
            ...
            if (data.Status == "1") {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    content.push([obj[i].IdCall, Name, CallType, OutletName, obj[i].ProductName, obj[i].Activity, Time, MonthOfYear, PAM, ASM, RSM, Button]);
                }
                callback(content)
                CloseLoading()
            } else {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.Status == "1") {
                ...
                var ViewImage = obj[0].Images == "0" ? baseUrlImage + "Calls/noimage.png" : baseUrlImage + "Calls/" + obj[0].Images;
