  ...
  componentDidMount = async () =>{
    ...
    constructor(props){
        ...
        this.state = {
          ...
          ShowLoading : false,
          StatusImage : false,
          ImageUri : global.ApiImage + 'noimage.png',
          ImageType : '',
          ImageFileName : '',
          Hobby : '',
          Address : '',
      ...
      openGallery = () => {
        ...
        ExecuteNewCustomer = async (ImagesName) =>{
          ...
          var details = {
            ...
            'DateOfBirth' : dataInput.DateOfBirth == "" ? "" : this.state.DateOfBirth.getFullYear()  + "-" + ("0" + (this.state.DateOfBirth.getMonth() + 1)).slice(-2)  + '-' + ("0" + (this.state.DateOfBirth.getDate())).slice(-2),
            ...
            'DateOfMarriage' : dataInput.DateOfMarriage == "" ? "" : this.state.DateOfMarriage.getFullYear()  + "-" + ("0" + (this.state.DateOfMarriage.getMonth() + 1)).slice(-2)  + '-' + ("0" + (this.state.DateOfMarriage.getDate())).slice(-2),
            'SpouseName' : dataInput.SpouseName,
            'ChildName1' : dataInput.ChildName1,
            'ChildName2' : dataInput.ChildName2,
            'DateOfBirthSpose' : dataInput.DataOfBirthSpouse == "" ? "" : this.state.DataOfBirthSpouse.getFullYear()  + "-" + ("0" + (this.state.DataOfBirthSpouse.getMonth() + 1)).slice(-2)  + '-' + ("0" + (this.state.DataOfBirthSpouse.getDate())).slice(-2),
            'DateofBirthChild1' : dataInput.DateofBirthChild1 == "" ? "" : this.state.DateofBirthChild1.getFullYear()  + "-" + ("0" + (this.state.DateofBirthChild1.getMonth() + 1)).slice(-2)  + '-' + ("0" + (this.state.DateofBirthChild1.getDate())).slice(-2),
            'DateofBirthChild2' : dataInput.DateofBirthChild2 == "" ? "" : this.state.DateofBirthChild2.getFullYear()  + "-" + ("0" + (this.state.DateofBirthChild2.getMonth() + 1)).slice(-2)  + '-' + ("0" + (this.state.DateofBirthChild2.getDate())).slice(-2),
            'Note' : dataInput.Note,
        ...
        fetch(global.Api + "/Api/InsertCustomer",
            {
              "signal": controller.signal,
              method : 'post',
              headers: {
        ...
        formValidation = () =>{
          if (this.state.Title!="" ** this.state.Specialization!="" && this.state.CustomerName!=""
                ...
                this.state.Area!="" && this.state.Outlet1!="" && this.state.DateOfBirth!="") {
                  this.setState({
                    ShowLoading:true
                  })
...
<View style={{flex:1,padding:20}}>
   ...
   <Loading/>
     ...
     <View></View>
           ...
           <HeaderBack Name="Register New Customer" navigation={this.props.navigation}/>
           <ScrollView>
...
<View style={{flex:1,paddingRight:10}}>
                <TouchableOpacity onPress={
                  ...
                  <Text style={{fontSize:12}}>Date Of Birth <Text style={{color:'red'}}>*</Text></Text>    
                <Text style={{fontSize:15,marginLeft:20,marginTop:5}}>
                  {
                  this.state.DateOfBirth!="" ?
                  ("0" + (this.state.DateOfBirth.getDate())).slice(-2) + "-" + ("0" + (this.state.DateOfBirth.getMonth() + 1)).slice(-2)  + '-' + this.state.DateOfBirth.getFullYear()
                   :"-"}</Text>    
...
<View style={{flex:1,paddingRight:10}}>
                ...
                <Text style={{fontSize:15,marginLeft:20,marginTop:5}}>
                  {
                  this.state.DateOfMarriage!="" ?
                  ("0" + (this.state.DateOfMarriage.getDate())).slice(-2) + "-" + ("0" + (this.state.DateOfMarriage.getMonth() + 1)).slice(-2)  + '-' + this.state.DateOfMarriage.getFullYear()
                   :"-"}</Text>  </Text>    
...
<View style={{flex:1,paddingRight:10}}>
          ...
          NameDateState : 'DataOfBirthSpouse'
                ...
                <Text style={{fontSize:15,marginLeft:20,marginTop:5}}>
                {
                  this.state.DataOfBirthSpouse !="" ?
                  ("0" + (this.state.DataOfBirthSpouse .getDate())).slice(-2) + "-" + ("0" + (this.state.DataOfBirthSpouse.getMonth() + 1)).slice(-2)  + '-' + this.state.DataOfBirthSpouse.getFullYear()
                   :"-"}</Text>    
...
<View style={{flex:1,paddingRight:10}}>
          ...
          NameDateState : 'DateofBirthChild1'
                ...
                <Text style={{fontSize:15,marginLeft:20,marginTop:5}}>
                {
                  this.state.DateofBirthChild1!="" ?
                  ("0" + (this.state.DateofBirthChild1.getDate())).slice(-2) + "-" + ("0" + (this.state.DateofBirthChild1.getMonth() + 1)).slice(-2)  + '-' + this.state.DateofBirthChild1.getFullYear()
                   :"-"}
                  </Text>    
                {/* <Text style={{fontSize:15,marginTop:3,marginLeft:10}}>-</Text> */}
                </TouchableOpacity>
...
<View style={{flex:1,paddingRight:10}}>
                ...
                <Text style={{fontSize:15,marginLeft:20,marginTop:5}}>
                {
                  this.state.DateofBirthChild2!="" ?
                  ("0" + (this.state.DateofBirthChild2.getDate())).slice(-2) + "-" + ("0" + (this.state.DateofBirthChild2.getMonth() + 1)).slice(-2)  + '-' + this.state.DateofBirthChild2.getFullYear()
                   :"-"}</Text>    
                {/* <Text style={{fontSize:15,marginTop:3,marginLeft:10}}>-</Text> */}
                </TouchableOpacity>
    </View>
 ...
 <View style={{flex:1,marginTop:60,flexDirection:'row',marginBottom:20}}>
    <View style={{flex:1}}></View>
    <View style={{flex:2}}>
  ...
  onPress={()=>{
    this.formValidation()
    // this.props.navigation.navigate("DeleteTes")
  }}
  title="  SAVE"
/>
    </View>
