...
<View style={{}}>
 ...
 <View style={[Styles.boxShadow, {borderBottomLeftRadius:10,borderBottomRightRadius:10, height:100,flexDirection:'row',padding:5,backgroundColor:'white',marginBottom:10}]}>
  ...
  />
  <Text style={{marginLeft:5,fontSize:12}}>{props.TimePlan}  </Text>
  
                            </View>
                        </View>

{
    props.StatusPlanCall == 0 && props.Status == 1 ?
    <View style={{flex:1,justifyContent:'center',
...
<Text style={{color:'white',textAlign:'center'}}>REASON NO CALL</Text>
</TouchableOpacity>
    </View>
    : props.Status != 1 && props.StatusPlanCall == 1  ?
    <View style={{flex:1,justifyContent:'center',
